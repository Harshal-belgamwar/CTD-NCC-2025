...
int main() {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-gradient-to-b from-[#2A2255] to-[#0C091F] sm:px-4">
      {/* Navbar */}
      <nav>
        <Navbar />
      </nav>
      ...
      {/* Language selector */}
      <div className="orbitron text-white mt-8 flex justify-end pr-[1%]">
        <select
          value={language}
      ...
      {/* Run & Submit buttons */}
      <div className="my-5 flex gap-5 sm:gap-8 w-[99%] text-white orbitron text-base sm:text-lg md:text-xl justify-center lg:justify-end">
        <button
          onClick={runCode}
