    ...
    <div className="orbitron mt-4 w-full max-w-6xl mx-auto bg-gradient-to-b from-[#6453DD] to-[#361D77] p-[2px] rounded-[10px]">
      <div className="w-full h-full bg-[#2A2255] rounded-[8px] flex flex-col md:flex-row justify-between items-center tracking-wide gap-3">
        ...
        <div className="p-1 md:p-2">
          <button
            className="bg-[#6453DD] border-[2px] border-[#6435DD] px-3 py-2 sm:px-4 sm:py-2 md:p-4 rounded-[5px] text-[0.7rem] sm:text-sm md:text-md text-center font-bold text-white leading-[100%] hover:bg-transparent hover:text-violet-300 cursor-pointer duration-200"
